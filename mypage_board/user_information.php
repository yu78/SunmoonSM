		...
		<table>
			<thead>
				<tr>
					...
					<td><a style="color:rgb(180, 180, 180);padding-right:20px;" href="my_reply.php">작성한 교환 댓글</td>
				</tr>
			</thead>
		</table>
		<hr />
			...
			?>
		       ...
		       <tr>
				...
				<div style="position: absolute; left: 0;right: 0; margin-left: auto; margin-right: auto; width: 200px;">
					<a class="btn btn-secondary my-2 my-sm-0" onclick="return confirm('탈퇴하시겠습니까?')" href="user_delete.php">회원탈퇴</a>
					<a class="btn btn-secondary my-2 my-sm-0" href="../../activation.php">인증하기</a>
				</div>
				<?php }?>
		</form>
	</div>
