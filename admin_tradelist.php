      ...
      <table>
        <thead>
          <tr>
            ...
            <td><a style="color:rgb(180, 180, 180);padding-right:20px;" href="admin_tradelist.php">강의교환 목록</td>
      ...
      <table class="table table-hover">
          ...
          //page번호 구하기
           if(isset($_GET['page'])){
              ...
              $sql = mq("select * from trade_board where name='".$_SESSION['userid']."' order by idx limit $start_num, $list");
