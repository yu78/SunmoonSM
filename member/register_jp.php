...
<html>
  <head>
    ...
    <script>
      ...
      var college_d = ["제약생명공학과", "식품과학.수산생명의학부", "간호학과", "물리치료학과", "치위생학과", "응급구조학과", "스포츠과학부", "스포츠과학전공", "무도경호학전공"];
  ...
  <body>
    <article class="container">
        ...
        <form action="../member/member_ok_jp.php" method="post" enctype="multipart/form-data" name="memform">
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="form-group">
              <label for="text">メール</label>
              <input type="text" class="form-control" name="email" placeholder="メールを入力してください。">
            ...
            <div class="form-group">
              <label for="text">学籍番号</label>
              <input type="text" class="form-control" name="student_idx" placeholder="学籍番号を入力してください。">
            </div>
            ...
            ?>
            <div class="form-group">
              <label for="college_name">単科大学</label>
            ...
            <br><label for="major_name">学科</label>
            ...
            <div class="form-group text-center">
              <button type="submit" class="btn btn-info">加入<i class="fa fa-check spaceLeft"></i></button>
              <button type="button" class="btn btn-warning" onClick='self.close()'>キャンセル</button>
