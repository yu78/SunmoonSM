...
<html>
  ...
  <body>
    <article class="container">
        ...
        <form action="../member/member_ok.php" method="post" enctype="multipart/form-data" name="memform">
        <div class="col-md-6 col-md-offset-3">
            ...
            <!-- <div class="form-group">
              ...
              <input type="text" name="userid" class="form-control" placeholder="이메일을 입력해 주세요.">
              <input type"text" name="emadress" class="form-control" value="@sunmoon.ac.kr" readonly>
            </div> -->

            <div class="form-group">
              <label for="text">이메일 주소</label>
              <input type="text" class="form-control" name="email" placeholder="이메일 주소를 입력해 주세요.">
              <input type"text" name="emadress" class="form-control" value="@sunmoon.ac.kr" readonly>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="student_idx" placeholder="학번을 입력해 주세요.">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" placeholder="닉네임을 입력해 주세요.">
            </div>

          <div class="form-group">
            <label for="college_name">단과대학</label>
            ...
            <br><label for="major_name">소속학부</label>
            ...
            <div class="form-group text-center">
              ...
              <button type="button" class="btn btn-warning" onClick='self.close()'>가입취소</button>
