      ...
      <table class="table-hover">
        <thead>
          <tr style="text-align:center;">
            <th width="150"><strong>번호</strong></th>
            ...
            <th width="500"><strong>단과대학</strong></th>
            <th width="500"><strong>학부</strong></th>
            <th width="500"><strong>가입일</strong></th>
            <th width="500"><strong>최근 접속일</strong></th>
            <th width="150"><strong>레벨</strong></th>
       ...
       <tbody>
         <tr style="text-align:center;">
           <td width="150"><?php echo $member['idx']; ?></td>
           ...
           <td width="500"><?php echo $member['college_name'];?></td>
           <td width="500"><?php echo $member['major_name'];?></td>
           <td width="500"><?php echo $member['m_date'];?></td>
           <td width="500"><?php echo $member['m_updated_date'];?></td>
           <td width="150"><?php echo $member['m_level'];?></td>
           <td width="150"><?php if ($member['m_level'] == 0){ ?><?php if ($member['id'] != "admin"){ ?><a href="admin_memDel.php?id=<?php=$member['idx']?>" class = "btn btn-danger btn-small-small delete" />Del</a><?php }} ?></td>
       </tr>
       </tr>
     </tbody>
