...
<head>
	...
	@media ( max-width: 768px ) {
		...
		function popupLogin() {
			...
			window.open("../member/login_jp.php", "a", "width=500, height=450, left=550, top=100");
			}
		...
		<body>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="../img/img5_jp.png" style="width:100%" alt="First slide">
						<div class="container">
					...
					<!--슬라이드5-->
					<div class="item">
						<img src="../img/본관.jpg" style="width:100%" data-src="" alt="Fifth slide">
						<div class="container">
							<div class="carousel-caption">
							</div>
						</div>
					...
					<!--슬라이드6-->
					<div class="item">
						<img src="../img/자연관.jpg" style="width:100%" data-src="" alt="Sixth slide">
						<div class="container">
							<div class="carousel-caption">
							</div>
						</div>
			...
			<br>
			<div class="container" style="margin:0 auto;height:auto;width:600px;">
        <p style="text-align:center;font-size:15pt;"><strong>最新の講義評価</strong><br></p>
          <div class="card bg-light mt-3">
           	<div class="card-header bg-light">
                ...
                ?>
                <?php echo $evaluation['lectureName']?><small>(<?php echo $evaluation['professorName']; ?>)</small> 総点 : <span style="color: red;"><?php echo $evaluation['totalScore']; ?></span><br>
                <?php } ?>
            </div>
          </div>
        </div>
