...
<head>
	...
	<style>
		...
		function popupLogin() {
			...
			window.open("../member/login_en.php", "a", "width=500, height=450, left=550, top=100");
			}
		...
		<body>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="../img/img5_en.png" style="width:100%" alt="First slide">
						<div class="container">
			...
			<br>
			<div id="jb-container">
				<p style="text-align:center;font-size:15pt;"><strong>The latest evaluation of lectures</strong></p>
				<?php
					$result = mq("SELECT * FROM evaluation order by idx desc limit 5");
						while($evaluation = mysqli_fetch_array($result)){
				?>
							<?php echo $evaluation['lectureName']?><small>(<?php echo $evaluation['professorName']; ?>)</small> Total : <span style="color: red;"><?php echo $evaluation['totalScore']; ?></span><br>
							<?php } ?>
			</div>
