    ...
    <div class="container">
      ...
      <form action="evaluation.php" method="get"  class="form-inline mt-3">
        <select class="form-control" name = "searchColumn" id="exampleSelect1">
					<option <?php echo $searchColumn=='lectureName'?'selected="selected"':null?> value="lectureName">강의이름</option>
          <option <?php echo $searchColumn=='professorName'?'selected="selected"':null?> value="professorName">교수이름</option>
        </select>
...
<?php
				...
				echo "<script>alert('마이페이지에서 인증 후 사용하실 수 있습니다.'); location.href='../index.php'; </script>";
    }else{
