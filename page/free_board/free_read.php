	...
	<!-- 목록, 수정, 삭제 -->
		<div id="bo_ser">
			<ul>
				...
				?>
				<li><a onclick="return confirm('수정하시겠습니까?')" href="free_modify.php?idx=<?php echo $bno; ?>">[수정]</a></li>
				<li><a onclick="return confirm('삭제하시겠습니까?')" href="free_delete.php?idx=<?php echo $bno; ?>">[삭제]</a></li>
					<?php }else{ }?>
			</ul>
		</div>
<!--- 댓글 불러오기 -->
