	...
	<div id="board_area">
        ...
        <div>
          ...
          <tr>
            ...
            <td><input type="password" class="form-control" name="userpw2" placeholder="새로운 비밀번호를 입력해주세요."></td>
          </tr>
         </tbody>
        </table>
      </div>
			...
			<div style="margin-left: auto; margin-right: auto;">
				<a class="btn btn-secondary my-2 my-sm-0" href="user_modify_ok.php">확인</a>
