			...
			?>
		       ...
		       <tr>
				...
				<div style="margin-left:auto; margin-right:auto; display:none;">
					<a class="btn btn-secondary my-2 my-sm-0" href="user_delete_jp.php">会員脱退</a>
				</div>
				<?php } else { ?>
				<div style="margin-left:auto; margin-right:auto; align:center;">
					<a class="btn btn-secondary my-2 my-sm-0" onclick="return confirm('脱退しますか？')" href="user_delete_jp.php">会員脱退</a>
					<a class="btn btn-secondary my-2 my-sm-0" href="../../activation.php">認証</a>
				</div>
				<?php }?>
		</form>
	</div>
