			...
			<table>
				<thead>
					<tr>
						...
						<td><a style="color:rgb(180, 180, 180);padding-right:20px;" href="my_reply_jp.php">作成したコメント</td>
					</tr>
				</thead>
			</table>
		<hr />
		<table class="table table-hover">
			<thead>
				...
				//page번호 구하기
				 if(isset($_GET['page'])){
						...
						$bo_mq = mq("select * from free_board where name='".$_SESSION['userid']."'");
						...
						$sql = mq("select * from free_board where name='".$_SESSION['userid']."'order by idx desc limit $start_num, $list");
			...
			<tbody>
				<tr>
								...
								<td width="400">
									<a href='../free_board/free_read_jp.php_jp?idx=<?php echo $free_board["idx"]; ?>'>
