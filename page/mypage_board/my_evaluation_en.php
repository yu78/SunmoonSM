				...
				<div class="card-header bg-light">
					<div class="row">
						...
						<div class="col-4 text-right">
							totalScore <span style="color: red;"><?php echo $evaluation['totalScore']; ?></span>
						</div>
					</div>
				</div>
				<div class="card-body">
					...
					<div class="row">
						<div class="col-9 text-left">
							creditScore <span style="color: red;"><?php echo $evaluation['creditScore']; ?></span>
							comfortableScore <span style="color: red;"><?php echo $evaluation['comfortableScore']; ?></span>
							lectureScore <span style="color: red;"><?php echo $evaluation['lectureScore']; ?></span>
						</div>
