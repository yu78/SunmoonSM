		...
		<thead>
			...
			<tbody>
				<tr>
					...
					<td width="100">
						<a href='../trade_board/trade_read_en.php?idx=<?php echo $trade_reply["con_num"]; ?>'>See the original text</a>
					</td>
			...
			<ul>
					...
					/* 처음 */
							...
							if($page <= 1){ //만약 page가 1보다 크거나 같다면
									...
									echo "<li><a href=?page=1".$subString.">front</a></li>"; //아니라면 처음글자에 1번페이지로 갈 수있게 링크
							}
