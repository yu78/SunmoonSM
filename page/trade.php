...
<html lang="ko">
 ...
 <body>
    <div id="board_area">
        ...
        <option<?php echo $searchColumn=='trade_header'?'selected="selected"':null?> value="trade_header">말머리</option>
	 		</select>
	 	<!--검색 창 부분-->
   ...
   <?php } ?>
            <table class="table table-hover">
            	...
            	<tbody>
            		<tr>
                        ...
                        <td width="520">
	                         <a href='trade_board/trade_read.php?idx=<?php echo $trade_board["idx"]; ?>'>
            ...
            <div id="write_btn">
              <a class="btn btn-secondary my-2 my-sm-0" data-toggle="modal" href="trade_board/trade_write.php">글쓰기</a>
            </div>
        </div>
        <!-- footer -->
