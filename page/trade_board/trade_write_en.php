...
<html lang="ko">
 ...
 <body>
	 <div id="board_write" style="margin-bottom:50px;">
            <div id="write_area">
              <h3>Trade</h3>
                <form action="trade_write_ok_en.php" method="post">
                    <div id="in_title">
                        <textarea name="title" id="utitle" rows="1" cols="55" class="form-control" placeholder="title" maxlength="100" style="margin-bottom:10px;" required></textarea>
                    </div>
										<div id="in_header">
                        <select name="trade_header" id="uheader" rows="1" cols="55" class="form-control" required>
													<option value="원해요">Want</option>
													<option value="드려요">Give</option>
													<option value="교환해요">Trade</option>
												</select>
                    </div>
                    <div id="wi_line"></div>
                    <div id="in_content">
