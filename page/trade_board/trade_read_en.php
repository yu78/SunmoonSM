...
<div id="board_read">
	<br><br><h5>[<?php echo $trade_board['trade_header']; ?>] <?php echo $trade_board['title']; ?></h5>
		<div id="user_info">
			...
			<br><?php echo $trade_board['date']; ?> Hits:<?php echo $trade_board['hit']; ?>
				<div id="bo_line"></div>
			</div>
			<div id="bo_content">
		...
		<div id="bo_ser">
			<ul>
				...
				<?php
				  ...
				  ?>
					<li><a onclick="return confirm('Do you want to modify?')" href="trade_modify_en.php?idx=<?php echo $bno; ?>">[modify]</a></li>
					<li><a onclick="return confirm('Do you want to delete?')" href="trade_delete_en.php?idx=<?php echo $bno; ?>">[delete]</a></li>
					<?php } else{ }?>
			</ul>
		</div>
<!--- 댓글 불러오기 -->
