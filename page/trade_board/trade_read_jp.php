...
<div id="board_read">
	<br><br><h5>[<?php echo $trade_board['trade_header']; ?>] <?php echo $trade_board['title']; ?></h5>
		<div id="user_info">
			...
			<br><?php echo $trade_board['date']; ?> ヒット:<?php echo $trade_board['hit']; ?>
				<div id="bo_line"></div>
			</div>
			<div id="bo_content">
	...
	<!-- 목록, 수정, 삭제 -->
		<div id="bo_ser">
			<ul>
				<li><a href="../trade_jp.php">[リストに]</a></li>
				<?php
					if(($_SESSION['userid'] == $trade_board['name'])||$_SESSION['level']==5) {
				  ?>
					<li><a onclick="return confirm('修正しますか？')" href="trade_modify_jp.php?idx=<?php echo $bno; ?>">[修正]</a></li>
					<li><a onclick="return confirm('削除しますか？')" href="trade_delete_jp.php?idx=<?php echo $bno; ?>">[削除]</a></li>
					<?php } else{ }?>
			</ul>
		</div>
<!--- 댓글 불러오기 -->
