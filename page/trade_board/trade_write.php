...
<html lang="ko">
 ...
 <body>
	 <div id="board_write" style="margin-bottom:50px;">
            <div id="write_area">
							<h3>강의교환</h3>
                <form action="trade_write_ok.php" method="post">
                    <div id="in_title">
                        <textarea name="title" id="utitle" rows="1" cols="55" class="form-control" placeholder="제목" maxlength="100" style="margin-bottom:10px;" required></textarea>
                    </div>
										<div id="in_header">
                        <select name="trade_header" id="uheader" rows="1" cols="55" class="form-control" placeholder="말머리" required>
