        ...
        <?php } ?>
            	...
            	<tbody>
            		<tr>
                        ...
                        <td width="620">
                          <a href='free_board/free_read_jp.php?idx=<?php echo $free_board["idx"]; ?>'>
            ...
            <div id="write_btn">
              <a class="btn btn-secondary my-2 my-sm-0" data-toggle="modal" href="free_board/free_write_jp.php">書き込み</a>
            </div>
        </div>
        <!-- footer -->
