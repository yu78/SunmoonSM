...
<body>
    <div class="container">
			<br><br><h2>講義評価</h2>
      <form action="evaluation_jp.php" method="get"  class="form-inline mt-3">
        <select class="form-control" name = "searchColumn" id="exampleSelect1">
					<option <?php echo $searchColumn=='lectureName'?'selected="selected"':null?> value="lectureName">講義の名前</option>
          <option <?php echo $searchColumn=='professorName'?'selected="selected"':null?> value="professorName">教授の名前</option>
        </select>
        ...
        <a class="btn btn-secondary my-2 my-sm-0" data-toggle="modal" style="margin-left: 5px;" href="evaluation_board/evaluation_write_jp.php">書き込み</a>
			</form>
