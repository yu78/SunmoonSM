  		...
  		<ul class="navbar-nav mr-auto">
  			...
  			<?php if($_SESSION['level']==5) { ?>
  			 <li class="nav-item active">
  				 <a class="nav-link" href="../../page/admin/adminlist.php">관리자 <span class="sr-only">(current)</span></a>
  			 </li>
  		 <?php }?>
  			<li class="nav-item">
      ...
      <table class="table-hover">
        <thead>
          <tr style="text-align:center;">
            <th width="200"><strong>번호</strong></th>
            <th width="250"><strong>아이디</strong></th>
            <th width="250"><strong>이름</strong></th>
            <th width="450"><strong>이메일</strong></th>
            <th width="250"><strong>학번</strong></th>
            <th width="550"><strong>단과대학</strong></th>
            <th width="550"><strong>학부</strong></th>
            <th width="450"><strong>가입일</strong></th>
            <th width="450"><strong>최근 접속일</strong></th>
            <th width="200"><strong>레벨</strong></th>
            <th width="150"><strong>삭제</strong></th>
          </tr>
        </thead>
       ...
       $sql = mq("select * from member order by idx desc limit $start_num, $list");
       ...
       <tbody>
         <tr style="text-align:center;">
           <td width="200"><?php echo $member['idx'];?></td>
           <td width="250"><?php echo $member['id'];?></td>
           <td width="250"><?php echo $member['name'];?></td>
           <td width="450"><?php echo $member['email'];?></td>
           <td width="250"><?php echo $member['student_idx'];?></td>
           <td width="550"><?php echo $member['college_name'];?></td>
           <td width="550"><?php echo $member['major_name'];?></td>
           <td width="450"><?php echo $member['m_date'];?></td>
           <td width="450"><?php echo $member['m_updated_date'];?></td>
           <td width="200"><?php echo $member['m_level'];?></td>
           <td width="150"><?php if ($member['id'] != "admin"){  ?>
             <a class="btn btn-danger" href="admin_memDel.php?id=<?php echo $member['id']; ?>">삭제</a>
           <?php } ?>
          </td>
        </tr>
     </tbody>
  ...
  $(document).ready(function() {
  	...
  	$( ".delete" ).click(function(){
  		if (window.confirm("한번 삭제한 자료는 복구할 방법이 없습니다.\n정말 삭제하시겠습니까?")) {
  			$.post('admin_memDel.php', { mode:"delete", user:$(this).attr("title") }, function(){
