 ...
 <head>
  ...
  @media ( max-width: 767px ) {
	...
	function popupLogin() {
		...
		window.open("../member/login_jp.php", "a", "width=500, height=600, left=550, top=100");
		}
		function popupRegister() {
			window.open("../member/register_jp.php", "a", "width=550, height=600, left=550, top=30");
		}
		</script>
 </head>
   ...
   <div class="collapse navbar-collapse" id="navbarColor01">
     <ul class="navbar-nav mr-auto">
       ...
       <?php if(!(isset($_SESSION['userid']))){	?>
         <li class="nav-item">
           <a class="nav-link" onclick="popupLogin();">ログイン</a>
         </li>
         <li class="nav-item">
           <a class="nav-link" onclick="popupRegister();">会員登録</a>
         </li>
      <?php } else { ?>
 ...
 <body>
		...
		<!--h3><a href="../index.php"><img src="../img/프로듀스SM로고.png"></a></h3-->
		 ...
		 <form class="form-inline my-2 my-lg-0">
	 		<div class="form-group">
	 			<form action="list_jp.php" method="get">
	 			<!--제목 내용 선택 박스-->
	 		<select class="form-control" name = "searchColumn" id="exampleSelect1">
	 			<option<?php echo $searchColumn=='title'?'selected="selected"':null?> value="title">タイトル</option>
	 			<option<?php echo $searchColumn=='content'?'selected="selected"':null?> value="content">内容</option>
        <option<?php echo $searchColumn=='trade_header'?'selected="selected"':null?> value="trade_header">話頭</option>
	 		</select>
	 	<!--검색 창 부분-->
   ...
   <?php if(isset($_SESSION['userid'])){ ?>
     <div style="display:block">
       <h6 align="right"><?php echo $_SESSION['userid']; ?>さん いらっしゃいませ。</h6>
     </div>
   <?php } else { ?>
     <br>
   ...
   <?php } ?>
            <table class="table table-hover">
            	...
            	<tbody>
            		<tr>
                        ...
                        <td width="520">
	                         <a href='trade_board/trade_read_jp.php?idx=<?php echo $trade_board["idx"]; ?>'>
            ...
            <div id="write_btn">
              <a class="btn btn-secondary my-2 my-sm-0" data-toggle="modal" href="trade_board/trade_write_jp.php">書き込み</a>
            </div>
        </div>
        <!-- footer -->
