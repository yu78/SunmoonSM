		...
		<body>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="../img/img1.jpg" style="width:100%" alt="First slide">
						<div class="container">
			...
			<div class="container" style="margin-bottom:70px;">
				<p style="text-align:center;font-size:15pt;"><strong>최신강의평가</strong><br></p>
							...
							?>
							<div class="card bg-light mt-3" style="margin:0 auto;height:auto;width:500px;">

							<a><?php echo $evaluation['lectureName']?>(<?php echo $evaluation['professorName']; ?>)</a>
							<a>총점 : <font color=red><?php echo $evaluation['totalScore']; ?></font></a>
							</div>
							<?php } ?>
