...
<div id="board_read">
	...
	<!-- 목록, 수정, 삭제 -->
		<div id="bo_ser">
			<ul>
				<li><a href="../trade.php">[목록으로]</a></li>
				<?php
					if(($_SESSION['userid'] == $trade_board['name'])||$_SESSION['m_level']==5)
						{  ?>
						<li><a href="trade_modify.php?idx=<?php echo $bno; ?>">[수정]</a></li>
						<li><a href="trade_delete.php?idx=<?php echo $bno; ?>">[삭제]</a></li>
					<?php }else{ }?>
			</ul>
		</div>
<!--- 댓글 불러오기 -->
